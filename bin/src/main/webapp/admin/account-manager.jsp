...
<form:form method="POST" action="/admin/account-manager/add" modelAttribute="accountForm" enctype="multipart/form-data">
    ...
    <div class="text-right">
        ...
        <button formaction="/admin/account-manager/delete" class="btn btn-danger" >Xóa</button>
        <button formaction="/admin/account-manager" formmethod="GET" class="btn btn-warning">Reset</button>
    </div>
</form:form><br/>
